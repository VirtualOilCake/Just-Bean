...
public class ValueHolder {
    ...
    public final static String scoreDataKey = "score";//the value key for score in the file
    public final static String dataName = "score_data";//the file name to store the score

    public final static String logTagD = "<My Log D>";//a log tag
    public final static String logTagV = "<My Log V>";//a log tag

    /**** Variables ****/
    public static int clickNumber = 0; //The click number in current time range.
